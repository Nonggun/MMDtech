...
//                }
        ...
        void Flash(Collider obj)
        {
            ...
            manager.FlashImage.color = new Color(1, 1, 1, 1);
            obj.gameObject.GetComponent<InventoryManager>().FlashImage.gameObject.SetActive(true);

            if (!obj.gameObject.GetComponent<Controller>().thisCamera.GetComponent<Motion>())
            {
                obj.gameObject.GetComponent<Controller>().thisCamera.AddComponent<Motion>();
            }
        }
