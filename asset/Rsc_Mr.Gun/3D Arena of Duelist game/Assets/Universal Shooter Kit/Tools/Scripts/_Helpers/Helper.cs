...
//                child.gameObject.layer = LayerMask.NameToLayer(name);
        ...
        {
            if (Math.Abs(position1.x - position2.x) < 0.01f && Math.Abs(position1.y - position2.y) < 0.01f && Math.Abs(position1.z - position2.z) < 0.01f &&
                Math.Abs(angles1.x - angles2.x) < 1 && Math.Abs(angles1.y - angles2.y) < 1 && Math.Abs(angles1.z - angles2.z) < 1)
            {
                position1 = position2;
                angles1 = angles2;
        ...
        [MenuItem("GameObject/USK/Movement Behavior (AI)", false, 30)]
        ...
        [MenuItem("GameObject/USK/Spawn Zone", false, 1)]
        ...
        [MenuItem("GameObject/USK/Game Manger", false, 50)]
        ...
        [MenuItem("GameObject/USK/Room Manager (Multiplayer)", false, 50)]
