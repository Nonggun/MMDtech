...
//			public RawImage SlotImage;
		...
		public class CharacterOffset
		{
			...
			public float CharacterHeight = -0.55f;
...
//							controller.WeaponManager.WeaponController.CrouchHands();
		...
		public static void PlayStepSound(Surface surface, AudioSource source, int tagIndex, float volume, string type)
		{
			...
			{
				var soundsArray = type == "character" ? surface.CharacterFootstepsSounds[tagIndex].FootstepsAudios : surface.EnemyFootstepsSounds[tagIndex].FootstepsAudios;
			...
			if (Input.touches.Length > 0)
			{
				for (var i = 0; i < Input.touches.Length; i++)
				{
					...
					if (touchId == -1 && touch.phase == TouchPhase.Began && 
					    (Type == "controller" ? touch.position.x < Screen.width / 2 : touch.position.x > Screen.width / 2) && 
...
//		static GameObject CreateStatsText(GameObject CharacterUI)
//		{
...
//
//			statsText.transform.parent = CharacterUI.transform;
//			statsText.transform.position = CharacterUI.GetComponent<Animator>().GetBoneTransform(HumanBodyBones.Head).position + Vector3.up;
...
#endif
//		public static void CheckButton (Controller controller, KeyCode keyCode, string direction)
//		{
//			if (Input.GetKeyDown(keyCode))
//			{
//				controller.pressButtonTimeout = 0;
////				controller.anim.SetBool("MoveButtonHasPressed", false);
//			}
//						
//			if (Input.GetKey(keyCode))
//			{
//				controller.pressButtonTimeout += Time.deltaTime;
//				
//				switch (direction)
//				{
//					case "forward":
//						controller.directionVector += Vector3.forward;
//						break;
//					
//					case "backward":
//						controller.directionVector -= Vector3.forward;
...
//					
//					case "right":
//						controller.directionVector += Vector3.right;
//						break;
//					
//					case "left":
//						controller.directionVector -= Vector3.right;
...
//				controller.hasMoveButtonPressed = true;
//							
//				if (controller.pressButtonTimeout > 0.2f)
//				{
////					controller.anim.SetBool("MoveButtonHasPressed", false);
...
//			{
//				if (controller.pressButtonTimeout < 0.4f)
//				{
//					controller.anim.SetBool("MoveButtonHasPressed", true);
//				}
//				else
