...
//                }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox(script.PickUpWeapon 
                ...
                : "To use this weapon as a pick-up item, just place it in the scene.", MessageType.Info);
            ...
            switch (script.currentTab)
            {
                ...
                case "Aim Settings":
                    ...
                    script.aimInspectorTabIndex = GUILayout.Toolbar(script.aimInspectorTabIndex, new[] {"First Person", "Third Person"});
                    EditorGUILayout.Space();
                    ...
                    switch (script.aimInspectorTabIndex)
                    {
                        case 0:
                            EditorGUILayout.BeginVertical("HelpBox");
                            script.activeAimFP = EditorGUILayout.ToggleLeft("Active Aim mode", script.activeAimFP, EditorStyles.boldLabel);
                            EditorGUILayout.EndVertical();
                    ...
                    if (script.activeAimTP || script.activeAimFP)
                    {
                        EditorGUILayout.Space();
                    }
//                    }
