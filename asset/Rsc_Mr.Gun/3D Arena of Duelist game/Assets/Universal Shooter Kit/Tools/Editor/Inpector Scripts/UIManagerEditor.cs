				...
				case 1:
					...
					switch (script.multiplayerGameInspectorTab)
					{
						case 0:
							...
							{
								case 0:
									script.lobbyInspectorTabDown = 3;
							...
							script.lobbyInspectorTabDown = GUILayout.Toolbar(script.lobbyInspectorTabDown, new[] {"Loadout Menu", "Avatars Menu", "Characters Menu"});
							
							switch (script.lobbyInspectorTabDown)
							{
								case 0:
...
//							                           " ◆ Not Teams UI - these are used for modes in which the <b>[Use Teams]</b> parameter <b>is not active</b>. All players will be displayed in one list.", style);
						...
						case 2:
							...
							EditorGUILayout.PropertyField(serializedObject.FindProperty("MultiplayerGameRoom.MatchStatsPrefab"), new GUIContent("K/D Stats"));
							EditorGUILayout.PropertyField(serializedObject.FindProperty("MultiplayerGameRoom.PlayerInfoPrefab"), new GUIContent("Player Info"));
							EditorGUILayout.EndVertical();
