...
//                            EditorGUILayout.EndVertical();
                        ...
                        case 2:
                            ...
                            if (script.CameraParameters.LockCamera)
                            {
                                ...
                                script.CameraParameters.FollowCursor = EditorGUILayout.ToggleLeft("Aim at Cursor", script.CameraParameters.FollowCursor);
                                EditorGUILayout.HelpBox("If this feature is active, the character will aim where the cursor is pointing." + "\n" +
                                                        "If not active, the character will aim always forward.", MessageType.Info);
                                
                                if (script.CameraParameters.FollowCursor)
                                {
                                    EditorGUILayout.Space();
